...
impl Geoname {
    ...
    fn admin_array(&self) -> [Option<&str>; 5] {
        [
            ...
            self.admin2.as_deref(),
            self.admin3.as_deref(),
            self.admin4.as_deref(),
        ]
    }
...
pub(crate) mod tests {
    ...
    pub(crate) fn waterloo_al() -> Geoname {
        Geoname {
            ...
            admin1: Some("AL".to_string()),
            admin2: Some("077".to_string()),
            admin3: None,
            admin4: None,
            population: 200,
    ...
    pub(crate) fn waterloo_ia() -> Geoname {
        Geoname {
            ...
            country: "US".to_string(),
            admin1: Some("IA".to_string()),
            admin2: Some("013".to_string()),
            admin3: Some("94597".to_string()),
            admin4: None,
            population: 68460,
    ...
    pub(crate) fn rochester() -> Geoname {
        Geoname {
            ...
            country: "US".to_string(),
            admin1: Some("NY".to_string()),
            admin2: Some("055".to_string()),
            admin3: Some("63000".to_string()),
            admin4: None,
            population: 209802,
    ...
    pub(crate) fn waco() -> Geoname {
        Geoname {
            ...
            feature_code: "PPLA2".to_string(),
            country: "US".to_string(),
            admin1: Some("TX".to_string()),
            admin2: Some("309".to_string()),
            admin3: None,
            admin4: None,
            population: 132356,
    ...
    pub(crate) fn st_louis() -> Geoname {
        Geoname {
            ...
            feature_code: "PPLA2".to_string(),
            country: "US".to_string(),
            admin1: Some("MO".to_string()),
            admin2: Some("510".to_string()),
            admin3: None,
            admin4: None,
            population: 315685,
    ...
    pub(crate) fn carmel() -> Geoname {
        Geoname {
            ...
            feature_code: "PPL".to_string(),
            country: "US".to_string(),
            admin1: Some("CA".to_string()),
            admin2: Some("053".to_string()),
            admin3: None,
            admin4: None,
            population: 3897,
    ...
    pub(crate) fn goessnitz() -> Geoname {
        Geoname {
            ...
            admin1: Some("15".to_string()),
            admin2: Some("00".to_string()),
            admin3: Some("16077".to_string()),
            admin4: Some("16077012".to_string()),
            population: 4104,
